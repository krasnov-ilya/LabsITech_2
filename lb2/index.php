...
<div id = "publishers-div">
  ...
  <lable>Get literature by publisher: </lable>
  ...
  <table style="border: 1px solid"><tr><th> Literature </th></tr>
...
<div id ="year-range-div">
  ...
  <form name ="year">
    <lable>Get items by year range: </lable>
  <?php 
...
<form name ="author">
    <lable>Get literature by author: </lable>
    <?php 
    require_once __DIR__ . "/vendor/autoload.php";
    $collection = (new MongoDB\Client) -> dbforlab -> literature;
    $cursor = $collection -> find();
